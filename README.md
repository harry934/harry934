...
<table>
  <tr>
    ...
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://harryyportfolio.netlify.app/">
        <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXBsYXc3eGdic2kycDd2enh2NDdzYjhtc3d5eGJtaW94ZHMzcDdpciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/RXwMNzYMfhGfddbhV7/giphy.gif" width="90%" style="border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.2);" />
      </a>
      <p>
        Simple website portfolio updating skills, interests, and projects.
        <br/><br/>
 ...
 <!-- Innovate Hub -->
    <td width="50%" valign="top" align="center">
      ...
      <p>
        <strong>Innovate Hub</strong> is a platform showcasing how young innovators develop and refine ideas.
        <br/><br/>
...
<summary style="cursor:pointer; padding:22px 0; text-align:center; list-style:none;">
  <div>
 <span style="
      ...
      font-weight:600;
      border-radius:50px;
      background:linear-gradient(135deg,#7f5af0,#6f42c1);
      color:white;
...
<div style="font-size:14px; color:#6e7781; margin-top:10px;">
      Explore earlier builds & development milestones
</div>
  </div>
</summary>
...
<div style="margin-top:20px;">
  ...
  <tr>
    ...
    <td width="50%" valign="top" align="center">
      <h3>⛑️ Emergency Response ML</h3>
      <a href="https://emergencyresponsee.streamlit.app/">
        <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExZWZvMHFpbWtkMms0bDAwZ3JpZXZvY2UxaXdkMjR4NTRyZXEybnRlcyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/lPrZAdsDJVs4hcXHVi/giphy.gif" width="90%" style="border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.2);" />
      </a>
      <p>
        ML model to analyze road camera footage for accidents or traffic flow.
        <br/><br/>
...
<!-- Children’s Home Support Platform -->
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://children-home.onrender.com/">
        <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExdmxzNGJnZnI3OWU3eWhjbWJ5Y2w3azhheWZ5azl4Z3V5NjN6ZTVvdyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/BQooLClng3Q4AiC5hb/giphy.gif" width="90%" style="border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.2); cursor:pointer;" />
      </a>
      <p>
        Web-based platform to facilitate donations and child sponsorship programs.
        <br/><br/>
  ...
  <tr>
    ...
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://stkmpesa.netlify.app/">
        <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ3JqcTN6cWt5OWpyOTIyczhxY3h1cHphbTVybDd2OGs5ZDJtYmxxdCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/dOKot4fwhzRroVuC7O/giphy.gif" width="90%" style="border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.2);" />
      </a>
      <p>
        Simple M-Pesa STK Push flow using Safaricom Daraja API.
        <br/><br/>
        <strong>Tech Stack:</strong> VS Code · HTML · CSS · JavaScript · M-Pesa Daraja API
      </p>
...
<!-- Online Food Ordering -->
    <td width="50%" valign="top" align="center">
      ...
      <a href="https://pizzachickncrust.up.railway.app/">
        <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExM29sbHVqd2d5Nzl4eXE0azZmcDhrZWQ3cDRkYzAwbWJtZnowOGNwZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/ZgTPZ7vRJPBcAylJdf/giphy.gif" width="90%" style="border-radius:12px; box-shadow:0 4px 10px rgba(0,0,0,0.2); cursor:pointer;" />
      </a>
      <p>
        Web-based restaurant system for food orders and payments.
        <br/><br/>
